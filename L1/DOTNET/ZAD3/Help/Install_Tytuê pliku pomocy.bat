...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /productName "Przyk³adowy tytu³ pomocy" /mediaBookList "Przyk³adowy tytu³ pomocy" > NUL
...
REM build time.
IF EXIST "Tytu³ pliku pomocy.msha" COPY /Y "Tytu³ pliku pomocy.msha" HelpContentSetup.msha
...
REM Uninstall first in case it is already there.  If not, it won't install below.  We'll ignore any error output
REM by redirecting it to NUL.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Vendor Name" /productName "Przyk³adowy tytu³ pomocy" /bookList "Przyk³adowy tytu³ pomocy" > NUL

REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation install /sourceUri "%CD%\Tytu³ pliku pomocy.msha"
